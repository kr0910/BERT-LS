...
class SFNotesProcessor(DataProcessor):
    """Processor for the livedoor data set."""
    ...
    def get_labels(self):
        """See base class."""
        return [
            '事業者案内・取次', '説明解決', 'ISP案内', '未対応分', 'メーカー案内・取次', '再申告待ち',
            'リモサポ案内', '営業案内・取次', '料金センタ案内・取次', '他IPセンタ取次', 'Ａ／Ｉ取次',
            'セキュサポ案内・取次', '話中調べ結果回答', 'その他', '説明解決（リブート回復）', 'メーカ案内',
            '通機案内', 'その他取次', '開通センタ案内', '社内案内・取次', 'マイグレ設定サポート案内',
            'サプライセンタ案内', 'オフサポ案内', 'セットアップ案内・取次', '光ＬＩＮＫセンタ案内'
        ]
